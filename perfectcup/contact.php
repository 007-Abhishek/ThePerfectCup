                ...
                $.ajax({
                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Email</strong> must exceed 5 characters. \ \
                                                 </div>');
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Message</strong> must cannot exceed 500 characters. \ \
                                                 </div>');
						
						} else if (html == 'message_short') {
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Message</strong> must exceed 5 characters. \ \
                                                 </div>');
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    ...
                    <p>Email:
                        <strong><a href="mailto:abhi.singh232001@gmail.com">info@theperfectcup.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>Mahadev Nagar
                            <br>Jaunpur, UP - 222001</strong>
                    </p>
                </div>
